...
#make O=$BUILDROOT_BUILD BR2_EXTERNAL=$BUILDROOT_BUILD stm32f429_disco_defconfig
#make O=$BUILDROOT_BUILD BR2_EXTERNAL=$BUILDROOT_BUILD qemu_arm_versatile_nommu_defconfig
#make O=$BUILDROOT_BUILD BR2_EXTERNAL=$BUILDROOT_BUILD qemu_arm_versatile_defconfig
make O=$BUILDROOT_BUILD BR2_EXTERNAL=$BUILDROOT_BUILD qemu_aarch64_virt_defconfig
